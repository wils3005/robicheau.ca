        ...
        <div className="section--columns">
          <div className="section--columns-left">
            ...
            <p>
              ...
              jobs, Nicole went back to school to study journalism with a goal
              to shed light on underreported crises and human rights abuses.
            </p>

            <p>
              She spent time working with journalists in Zambia and Sierra
              Leone, supporting them to report more effectively on human rights
              abuses. She spent time volunteering at an independent newspaper in
              Moldova championing human rights as well as some time in Geneva
              volunteering for an organization that had her going to the UN
              Human Rights Council daily.
            </p>
            ...
            <p>
              ...
              disasters, mass migrations, protracted crises and epidemics, such
