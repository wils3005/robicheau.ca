      ...
      <div className="flex flex-col lg:flex-row">
        <div className="flex flex-col lg:w-2/3">
          ...
          <p>
            ...
            Scotia, and now call Toronto home. I’m a queer, non-binary, Acadian
            settler raised by a single mother, and these intersections inform
            the work I do, and the way I engage with the world.
          </p>
          <p>
            ...
            jobs in expensive cities and think all Canadians deserve to be paid
            a living wage. After many years working these jobs, I went back to
            school to study journalism with a goal to shed light on
            underreported crises and human rights abuses.
          </p>
          <p>
            I spent time working with journalists in Zambia and Sierra Leone,
            supporting them to report more effectively on human rights abuses. I
            spent time volunteering at an independent newspaper in Moldova
            championing human rights as well as some time in Geneva volunteering
            for an organization that had me going to the UN Human Rights Council
            daily.
          </p>
          <p>
            ...
            and I returned several years later to respond to Hurricane Matthew.
            I have also supported responses to cholera in Sierra Leone, and to
            the 2014 West Africa Ebola outbreak. I was in Nepal after the
            earthquake in 2015, in the Philippines after Typhoon Haiyan, and in
            Bosnia recently for a mass migration response. In Canada, I
            supported a BC wildfire operation, as well as the Alberta floods
            response in 2012.
          </p>
          <p>
