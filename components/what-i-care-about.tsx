    ...
    >
      ...
      <div style={{ padding: "1rem" }}>
        ...
        <p>
          ...
          to identify what they need, and work with them on creating this. There
          are also a large number of folks in Davenport and across the city of
          Toronto who are underhoused and being pushed out of the city. This
          can’t continue to happen; we have to make it harder to raise rents and
        ...
        <p>
          I grew up in Saint Mary’s Bay, in Nova Scotia, where recently Mi'kmaw
          fishers have been exercising their right to fish for a moderate
          livelihood. I stand firmly with the Mi'kmaw and all other Indigenous
          peoples across Turtle Island asserting their rights to land and
          resources.
        </p>
